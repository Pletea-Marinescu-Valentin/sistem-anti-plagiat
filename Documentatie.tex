...
\begin{figure}[H]
    ...
    \begin{tikzpicture}[
        ...
        \node[class, below =1.4cm of eye] (pupil) {Pupil\\\textit{Analiză pupile}\\\rule{3.5cm}{0.4pt}\\-x\\-y\\-pupil\_coords\\\rule{3.5cm}{0.4pt}\\+detect()\\+get\_position()};
...
\begin{figure}[H]
    \centering
        \begin{tikzpicture}[
                ...
                \node[font=\sffamily\scriptsize] at (6,-3.8) {loop [în timpul monitorizării]};
